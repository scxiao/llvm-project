...
toy.func @main() {
  ...
  %4 = toy.add_one %3 : tensor<3x2xf64>
...
// CHECK:         [[VAL_9:%.*]] = memref.alloc() : memref<3x2xf64>
...
// CHECK:             [[VAL_12:%.*]] = affine.load [[VAL_8]]{{\[}}[[VAL_11]], [[VAL_10]]] : memref<2x3xf64>
// CHECK:             affine.store [[VAL_12]], [[VAL_7]]{{\[}}[[VAL_10]], [[VAL_11]]] : memref<3x2xf64>
// CHECK:         affine.for [[VAL_13:%.*]] = 0 to 3 {
// CHECK:           affine.for [[VAL_14:%.*]] = 0 to 2 {
// CHECK:             [[VAL_15:%.*]] = affine.load [[VAL_7]]{{\[}}[[VAL_13]], [[VAL_14]]] : memref<3x2xf64>
// CHECK:             [[VAL_17:%.*]] = arith.mulf [[VAL_15]], [[VAL_15]] : f64
// CHECK:             affine.store [[VAL_17]], [[VAL_6]]{{\[}}[[VAL_13]], [[VAL_14]]] : memref<3x2xf64>
// CHECK:         toy.print [[VAL_6]] : memref<3x2xf64>
// CHECK:         affine.for [[VAL_19:%.*]] = 0 to 3 {
// CHECK:           affine.for [[VAL_20:%.*]] = 0 to 2 {
// CHECK:             [[VAL_21:%.*]] = affine.load [[VAL_6]]{{\[}}[[VAL_19]], [[VAL_20]]] : memref<3x2xf64>
// CHECK:             [[VAL_22:%.*]] = arith.addf [[VAL_21]], [[VAL_0]] : f64
// CHECK:             affine.store [[VAL_22]], [[VAL_9]]{{\[}}[[VAL_19]], [[VAL_20]]] : memref<3x2xf64>
// CHECK:         toy.print [[VAL_9]] : memref<3x2xf64>
...
// CHECK:         memref.dealloc [[VAL_9]] : memref<3x2xf64>
...
// OPT:         [[VAL_12:%.*]] = memref.alloc() : memref<3x2xf64>
...
// OPT:             [[VAL_13:%.*]] = arith.addf [[VAL_11]], [[VAL_0]] : f64
// OPT:             affine.store [[VAL_13]], [[VAL_12]]{{\[}}[[VAL_8]], [[VAL_9]]] : memref<3x2xf64>
// OPT:         toy.print [[VAL_12]] : memref<3x2xf64>
// OPT:         memref.dealloc [[VAL_7]] : memref<2x3xf64>
// OPT:         memref.dealloc [[VAL_6]] : memref<3x2xf64>
// OPT:         memref.dealloc [[VAL_12]] : memref<3x2xf64>
